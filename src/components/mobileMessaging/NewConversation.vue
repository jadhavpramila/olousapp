  ...
  <div class="new-conversation md:pl-3 pt-1 w-full" id="new-conversation">
    <div class="flex flex-col popup-height" id="headerPart">
      <div class="flex-shrink-0">
        ...
        >
          <div class="font-weight-700 text-[#333333] md:mb-2 text-lg">
            New Network
          </div>
          <button
            class="rounded-2xl w-[4.375rem] h-[1.875rem] w-full ml-auto bg-[#333333]"
            @click="onCancelNewMessage()"
          >
            <span class="m-auto text-sm text-white">Cancel</span>
          </button>
        ...
        >
          ...
          <AutoComplete
            ...
            @item-unselect="onUserUnSelect($event)"
            class="form-control w-full rounded-3xl focus:outline-none border-[#707070] border items-center"
...
export default {
  ...
  setup(props, context) {
    ...
    onMounted(() => {
      alert("mounted New conv");
      alert(getter_device.value);
    ...
    function onCancelNewMessage() {
      router.push({ name: appConstants.routes.MOBILEMESSAGING });
    }
